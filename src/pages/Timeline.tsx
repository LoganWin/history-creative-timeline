                    ...
                    <div className="relative flex items-center" key={event.year + idx}>
                      ...
                      >
                        <div className="card w-full min-h-[260px] bg-base-100 shadow-2xl border border-base-content/10 overflow-hidden flex flex-col sm:flex-row">
                          {isFlipped ? (
                            <div className="card-body gap-4 p-6 sm:p-8 text-left flex-1">
                              <div>
                              ...
                              <div className="card-actions justify-start">
                                <button className="btn btn-outline" onClick={() => setFlippedIndex(null)}>
                                  Back
                                </button>
                              </div>
                            </div>
                            ...
                            <>
                              ...
                              >
                                <div>
                                  ...
                                  <p className="text-base-content/80">{event.label}</p>
                                </div>
                                <div className={`card-actions ${isLeft ? "justify-end" : "justify-start"}`}>
                                  <button className="btn btn-primary" onClick={() => setFlippedIndex(idx)}>
                                    Learn More
                                  </button>
                                </div>
                              </div>
